...
class GR4(SurfaceLayerComponent):
    ...
    def run(self,
            ...
            # component inputs
            rainfall, potential_evapotranspiration,
        ...
        p = rainfall * dt
        e = potential_evapotranspiration * dt
        ...
        # water-limited conditions (i.e. remainder energy 'en')
        ...
        tanh_en_over_x1 = \
            np.where(water_limited, np.tanh(en_over_x1), 0.0)
